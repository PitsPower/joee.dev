import{d as l,o,a as r,f as a,t as i,m as h,n as c,_,F as n,r as s,k as f,q as y}from"./VANZdYBv.js";import{u as b}from"./CqLldxa6.js";const w=["href"],k=["src","alt"],v={class:"info"},j=l({__name:"Project",props:{title:{},color:{},whiteText:{type:Boolean},projectUrl:{},imageUrl:{}},setup(m){return(e,p)=>(o(),r("a",{href:e.projectUrl,target:"_blank",class:c(["project",{[e.color]:!0,white:e.whiteText,clicky:e.projectUrl!==void 0}])},[a("img",{src:e.imageUrl,alt:e.title},null,8,k),a("div",v,[a("h1",null,i(e.title),1),a("p",null,[h(e.$slots,"default",{},void 0,!0)])])],10,w))}}),U=_(j,[["__scopeId","data-v-d4251bc0"]]),A={class:"pt-5 pb-52"},T={key:0},x=a("h1",{class:"text-center font-bold"},"to be continued...",-1),P=l({__name:"projects",setup(m){b({title:"joee.dev - projects",ogTitle:"projects",ogSiteName:"joee.dev",ogImage:"/img/logo/256.png",ogDescription:"Take a look at my projects!"});const e=[{name:"Allchemy",color:"from-yellow-400",whiteText:!1,projectUrl:"https://allchemy.io",imageUrl:"/img/allchemy.png",description:`
    ...
    `}];return(p,S)=>{const g=U;return o(),r("div",A,[(o(),r(n,null,s(e,t=>f(g,{class:"mb-10",title:t.name,color:t.color,"white-text":t.whiteText,"project-url":t.projectUrl,"image-url":t.imageUrl},{default:y(()=>[typeof t.description=="string"?(o(),r("div",T,i(t.description),1)):(o(!0),r(n,{key:1},s(t.description,(u,d)=>(o(),r("div",{class:c({"mt-3":d>0})},i(u),3))),256))]),_:2},1032,["title","color","white-text","project-url","image-url"])),64)),x])}}});export{P as default};
